			...
			<div id="main">
				...
				<div class="detailButton" role="group">
					<button id="list_btn" style="float: right;" type="button" class="list-button"
						onClick="location.href='/tipBoard'">목록</button>
					<c:if test="${sessionScope.member.member_id == detail.writer }">
						<button id="modity_btn" class="list-button"
							style="float: left; margin-right: 20px;"
							onclick="location.href='/tipUpdate/${detail.bseq}'">수정</button>
						<button style="float: left;" class="list-button"
							onclick="location.href='/tipDelete/${detail.bseq}'" href="javascript:history.back();">삭제</button>
					</c:if>
				</div>
			</div>
