	...
	<div id="contents">
		<div class="body">
			<div id="main">
				<div class="insert">
					<div class="col-xs-12">
						<form action="/companyUpdateProc" method="post">
							<div class="form-group">
								<label style="margin-left: 20px;" for="title">제목</label> <input
							...
							<div class="form-group">
								...
								<textarea
									style="margin-left: 20px; margin-top: 20px; margin-bottom:20px; width: 910px; height: 300px;"
									class="form-control" id="content" name="content" rows="3">${detail.content}</textarea>
							</div>
							<input type=hidden name="bseq" value="${bseq}" />
							<button style="margin-top: 20px; float: right;" type="button"
								class="list-button" onClick="location.href='javascript:history.back();'">리스트</button>
							<button style="margin-top: 20px; float: left;" type="submit"
								class="list-button">수정</button>
						</form>
					</div>
				</div>
			</div>
